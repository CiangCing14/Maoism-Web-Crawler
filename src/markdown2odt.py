...
def run(mdf,lan):
    ...
    t=t.replace('\n* [','\n[')
    t=t.replace('<h1>','<text:h text:style-name="P10" text:outline-level="1"><text:span text:style-name="T3">').replace('</h1>','</text:span></text:h>')
    t=t.replace('<h2>','<text:h text:style-name="P11" text:outline-level="2"><text:span text:style-name="T3">').replace('</h2>','</text:span></text:h>')
    t=t.replace('<h3>','<text:h text:style-name="P12" text:outline-level="3"><text:span text:style-name="T3">').replace('</h3>','</text:span></text:h>')
    t=t.replace('<h4>','<text:h text:style-name="P13" text:outline-level="4"><text:span text:style-name="T3">').replace('</h4>','</text:span></text:h>')
    t1=t.split('<p>')
    tt=''
    ...
    t=t.replace('>','>\n').strip()
    t='%s\n<text:p><text:soft-page-break/></text:p>%s\n%s'%(te.split('<text:p text:style-name="P2"/><text:h text:style-name="P10" text:outline-level="1"><text:soft-page-break/>#<text:span text:style-name="T2">新闻标题</text:span>')[0],t,'</office:text></office:body>%s'%te.split('</office:text></office:body>')[1])
    t=t.replace('%LAN%',lan)
