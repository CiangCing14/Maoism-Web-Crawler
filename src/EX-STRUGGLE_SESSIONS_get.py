...
if len(dr)==0:
    ...
    for a in range(len(hl)):
        ...
        h2=h.split('<div class="entry-content">')[1].split('<div id="atatags-')[0].split('<div id="jp-post-flair"')[0]
        h={'title':h.split('<meta property="og:title" content="')[1].split('"')[0].strip(),
           ...
           'author':h.split('<span class="author vcard">')[1].split('</span>')[0].split('">')[1].split('<')[0],
